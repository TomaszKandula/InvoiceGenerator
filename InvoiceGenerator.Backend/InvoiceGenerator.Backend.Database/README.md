...
1. `Add-Migration -StartupProject InvoiceGenerator -Project InvoiceGenerator.Backend.Database -Context DatabaseContext -OutputDir Migrations <name>`
1. `Update-Database -StartupProject InvoiceGenerator -Project InvoiceGenerator.Backend.Database -Context DatabaseContext`

To remove migration:

1. `Remove-Migration -StartupProject InvoiceGenerator -Project InvoiceGenerator.Backend.Database -Context DatabaseContext`
